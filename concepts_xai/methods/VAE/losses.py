...
def bernoulli_fn_wrapper(activation="logits", subtract_true_image_entropy=False):

    def loss_fn(true_images, reconstructed_images):
        return bernoulli_loss(true_images, reconstructed_images, activation, subtract_true_image_entropy)
